...
import java.util.*;
import javax.swing.*;
public class WfTotalExecutionTimeCalculator extends Thread {
   JTextArea jta;
  Pool threadPool;
  ...
  int count;
  int poolSize;
  public WfTotalExecutionTimeCalculator(LinkedList queueOut,Vector phaseStorer,Vector jobsHistoryStorer,int poolSize, JTextArea jta,int jobsPerPhase,Pool threadPool,int count) {
    this.count=count;
