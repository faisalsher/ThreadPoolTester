...
import java.util.*;
import javax.swing.*;
public class TotalExecutionTimeCalculator extends Thread {
   JTextArea jta;
  ...
  int count;
  int poolSize;
  public TotalExecutionTimeCalculator(LinkedList queueOut,Vector phaseStorer,Vector jobsHistoryStorer,int poolSize, JTextArea jta,int jobsPerPhase,ThreadPool threadPool,int count) {
    this.count=count;
